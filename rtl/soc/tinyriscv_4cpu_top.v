...
module tinyriscv_4cpu_top(
    ...
    //   模块尚未就绪，暂且注释掉，信号已做tie-off
    // ================================================================
    // tinyriscv_soc_top u_cpu1 (
    //     .clk            (cpu1_clk),
    //     .rst            (rst),
    //     .over           (cpu1_over),
    //     .succ           (cpu1_succ),
...
// );
    ...
    // ================================================================
    // CPU1-3 输出信号 tie-off（模块注释掉后避免悬空）
//   待真实模块接入后删除这些assign
    // ================================================================
    assign cpu1_over   = 1'b0;
    assign cpu1_succ   = 1'b0;
    assign cpu1_uart_tx = 1'b0;
    assign cpu1_pwm    = 4'h0;
    assign cpu1_bridge_o = 8'h00;
    assign cpu1_scl_o   = 1'b0;
    assign cpu1_scl_oe  = 1'b0;
    assign cpu1_sda_o   = 1'b0;
    assign cpu1_sda_oe  = 1'b0;

    assign cpu2_over   = 1'b0;
    assign cpu2_succ   = 1'b0;
    assign cpu2_uart_tx = 1'b0;
    assign cpu2_pwm    = 4'h0;
    assign cpu2_bridge_o = 8'h00;
    assign cpu2_scl_o   = 1'b0;
    assign cpu2_scl_oe  = 1'b0;
    assign cpu2_sda_o   = 1'b0;
    assign cpu2_sda_oe  = 1'b0;

    assign cpu3_over   = 1'b0;
    assign cpu3_succ   = 1'b0;
    assign cpu3_uart_tx = 1'b0;
    assign cpu3_pwm    = 4'h0;
    assign cpu3_bridge_o = 8'h00;
    assign cpu3_scl_o   = 1'b0;
    assign cpu3_scl_oe  = 1'b0;
    assign cpu3_sda_o   = 1'b0;
    assign cpu3_sda_oe  = 1'b0;
