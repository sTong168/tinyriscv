...
// 带默认值和控制信号的流水线触发器（hold时冻结当前值，不复位为默认值）
module cpu2_gen_pipe_dff_freeze #(
    parameter DW = 32)(
