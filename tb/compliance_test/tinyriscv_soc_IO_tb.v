...
module riscv_soc_IO_tb;
    ...
    wire [`RegBus] x3  = tinyriscv_top_IO_0.u_soc.u_tinyriscv.u_regs.regs[3];
    wire [`RegBus] x26 = tinyriscv_top_IO_0.u_soc.u_tinyriscv.u_regs.regs[26];
    wire [`RegBus] x27 = tinyriscv_top_IO_0.u_soc.u_tinyriscv.u_regs.regs[27];
...
`endif
    ...
    // generate wave file
    initial begin
        $dumpfile("riscv_soc_IO_tb.vcd");
        $dumpvars(0, riscv_soc_IO_tb);
    end
